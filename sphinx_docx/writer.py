...
from sphinx_docx import docx
from sphinx_docx.highlight import DocxPygmentsBridge
...
class DocxTranslator(nodes.NodeVisitor):
    ...
    def __init__(self, document, builder):
        """Set up the composer, the stacks and the sphinx_docx styles.
        ...
        self._create_sphinx_docx_styles()
    ...
    def _make_paragraph(
        ...
        if style is not None:
            ...
            if style == DocxTranslator.TABLE_BOTTOM_MARGIN_STYLE_NAME:
                ...
                style_kind = Paragraph.SPHINX_DOCX_STYLE
        else:
    ...
    def _create_sphinx_docx_styles(self):
