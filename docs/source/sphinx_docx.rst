...
sphinx_docx is a builder extension for `Sphinx`_.
...
sphinx_docx defines the below configurations to specify the style file or to
...
These configurations can be added to ``conf.py``::
  ...
  docx_documents = [
      ('index', 'sphinx_docx.docx', {
           'title': 'sphinx_docx documentation',
           'created': 'author'
...
If the title of a rubiric directive is "Footnotes", sphinx_docx ignores the title as the latex write does
